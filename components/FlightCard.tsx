    ...
    <div className="bg-white rounded-[2rem] px-5 py-4 shadow-sm border border-white/20 mb-3 overflow-hidden relative">
      ...
      <div className="flex items-center mb-4">
        <div className="flex items-center gap-3">
          <div className="w-14 h-14 bg-[#F5EFEF] rounded-xl flex items-center justify-center text-lg shadow-inner">
            ✈️
          </div>
          <div>
            <h3 className="text-xl font-black text-[#3E2723] tracking-widest leading-none">{flight.type} <span className="text-xl font-black text-[#3E2723]/70 tracking-wide leading-none">{flight.date}</span></h3>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="text-center">
          <p className="text-xl font-bold text-[#3E2723]">{flight.departureTime}</p>
        </div>
        <div className="text-center">
          <p className="text-xl font-bold text-[#3E2723]">{flight.arrivalTime}</p>
        </div>
      </div>
